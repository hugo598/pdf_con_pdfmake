...
var interlineado = 1.2;
		...
		router.route('/toma_domiciliaria')
			.get( function ( req, res )
			{
				...
				var docDefinition =
				{
					...
					{
						text: 'SOLICITUD DE CONEXIÓN PARA TOMA DOMICILIARIA',
						alignment: 'center',
						// width: 375,
					...
					},
					{
						...
						columns: [
							{
								width: 285,
								text: [	'LEY ESTATAL DE AGUA POTABLE\n',
												'ART. 84.-­‐ TODO USUARIO TANTO DEL SECTOR PUBLICO COMO SECTOR SOCIAL O PRIVADO ESTA OBLICAGO AL PAGO DE LOS SERVICIOS DE POTABLE, ALCANTARILLADO Y TRATAMIENTO	DE AGUAS RESIDUALES QUE PRESTA EL SISTEMAOPERADOR INTERMUNICIPAL DE AGUA POTABLE Y SANEAMIENTO DE TEQUESQUITENGO, MORELOS.\n',
												'ART. 85.-­‐ LOS USUARIOS DEBERAN PAGAR EL IMPORTE DE LA TARIFA O CUOTA POR LOS SERVICIOS PUBLICOS DE AGUA POTABLE Y SANEAMIENTO.\n',
												'ART.	87.-­‐ EL SERVICIO DE AGUA POTABLE QUE DISFRUTAN TODOS LOS USUARIOS EN EL MUNICIPIO SERA TANDEADO Y MEDIDO.'
											],
								style: 'subindice_2',
								// alignment: 'justify',
								margin: [3,5,8,10],
							...
							{
								width: 285,
								text: ['ART. 85.-­‐ LOS USUARIOS DEBERAN PAGAR EL IMPORTE DE LA TARIFA O CUOTA POR LOS SERVICIOS PUBLICOS DE AGUA POTABLE Y SANEAMIENTO.',
												'ART.	87.-­‐ EL SERVICIO DE AGUA POTABLE QUE DISFRUTAN TODOS LOS USUARIOS EN EL MUNICIPIO SERA TANDEADO Y MEDIDO.'
											],
								style: 'subindice_2',
								margin: [8,5,0,10],
